...
import "./ForgotPassword.css"; // Uses the same CSS for overall layout and form-box
...
const ChangePassword = ({ onCancel}) => {
  ...
  return (
    <div className="fullscreen-bg">
      ...
      <div className="form-box_cp">
        <h2 className="form-title_cp">Change your password</h2>
